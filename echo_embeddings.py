...
class EchoParser(nn.Module):
    def __init__(self, tokenizer, templates, max_length=None):
        ...
        if self.tokenizer.pad_token is None:
            ...
            self.tokenizer.pad_token_id =  self.tokenizer.pad_token_id or self.tokenizer.eos_token_id  # newly added
...
class EchoEmbeddingsMistral(nn.Module):
    ...
    def forward(self, xs):
        ...
        outputs = self.model(**inputs, output_hidden_states=True, return_dict=True).hidden_states[-1]
